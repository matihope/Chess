...
//
//namespace Chess {
//Tile::Tile() : m_collision_shape(RectCollision(this)), m_piece(Chess::Position(0, 0)) {
...
//}
//
//Tile::Tile(Position square) : Tile::Tile(), m_piece(Chess::Position(0, 0)) { setSquare(square); }
//
...
//
//void Tile::onRelease() {
//  Board *parent = dynamic_cast<Board *>(getParent());
//  parent->tilePressed(this);
//}
//
//void Tile::setSquare(Position square) {
//  m_square = square;
...
//}
//
//Position Tile::getSquare() { return m_square; }
//
