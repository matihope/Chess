...
bool Chess::Rook::_isMovePossible(Board &board, Position end_pos, const Move *last_move) {
...
bool Chess::Rook::wouldMoveBePossible(Board &board, Position start_pos, Position end_pos, const Move *last_move) {
  // horizontal move
